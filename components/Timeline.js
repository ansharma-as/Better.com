  ...
  return (
    <>
      <section className="m-auto max-w-screen-xl pb-20 text-center">
        <h2 className=" mt-10 font-bold text-textPrimary leading-heading m-0 p-0 tracking-normal w-auto text-2xl md:text-3xl md:tracking-tight mb-16">
          Company timeline
        </h2>
        ...
        <div className="relative m-auto w-1/3  before:absolute before:left-1/2 before:block before:h-full before:w-1 before:translate-x-2/4 before:bg-accentBackground">
          <div className="relative flex flex-col justify-center items-center ">
            <div className="inline-block rounded-full bg-backgroundInverseSecondary px-8 py-2">
              <h3 className="font-bold leading-heading m-0  tracking-normal w-auto text-md md:text-xl text-white bg-green-700 px-6 mx-auto py-2 rounded-full">
                2014
              </h3>
            </div>
            <div className="rounded-sm relative w-full bg-accentSecondary my-lg p-base lg:p-xl -ml-base -translate-x-1/2 lg:-ml-2xl">
              <p className=" font-light lg:font-normal bg-[#e9edeb] rounded-xl p-3  leading-body m-0  text-left text-textSecondary text-xs md:text-md lg:text-lg lg:p-8">
          ...
          <div className="relative flex flex-col items-center">
            <div className="inline-block rounded-full bg-backgroundInverseSecondary px-8 py-2">
              <h3 className="font-bold leading-heading m-0  tracking-normal w-auto text-lg md:text-xl text-white bg-green-700 px-6 mx-auto py-2 rounded-full">
                2015
              </h3>
            </div>
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="rounded-sm relative w-full bg-accentSecondary my-lg p-base lg:p-xl ml-8 translate-x-1/2 lg:ml-3xl">
              <p className=" font-light lg:font-normal bg-[#e9edeb] rounded-xl p-3  leading-body m-0  text-left text-textSecondary text-xs md:text-md lg:text-lg lg:p-8">
                Better Mortgage is pioneering products, partnerships, and real
                estate strategies that deliver the best outcomes for customers
