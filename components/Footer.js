  ...
  return (
    <footer className="bg-white py-10 px-5">
        ...
        <div className="flex space-x-4 mt-8 ml-4 p-6">
          <Link href="#" passHref>
            <Image
              src="/images/footer/facebook.png"
              alt="Facebook"
              width={24} // Adjust size accordingly
              height={24} // Adjust size accordingly
            />
          </Link>
          <Link href="#" passHref>
            <Image
      ...
      <div className="mt-8 p-6 text-sm">
        ...
        <p className="text-xs mt-4">
          2 Better Mortgage&apos;s One Day HELOC&trade; promotion offers qualified customers
          who provide certain required financial information/documentation to
          Better Mortgage within 4 hours of locking a rate on a HELOC loan the
          opportunity to receive an underwriting determination from Better
          Mortgage within 24 hours of their rate lock. The underwriting
        ...
        <p className="text-xs mt-6">
          ...
          is licensed by the California Bureau of Real Estate, license #
          02164055. Each office independently owned and operated.
        </p>

        <p className="text-xs mt-6">
          Better Cover, LLC is a licensed insurance agency and can only provide
          insurance products to customers in states where it is licensed. Not
          available in all states. In California, Better Cover, LLC is an
          insurance broker operating under the trade name Better Cover.
        </p>

        <p className="text-xs mt-6">
          Better Inspect, LLC is a limited liability company with its principal
          place of business located in California and provides home inspection
          services. This company does not perform any repairs and the home
          inspection services offered by Better Inspect, LLC do not constitute a
          guarantee or warranty of the property inspected.
        </p>

        <p className="text-xs mt-6">
          Better Settlement Services, LLC provides title insurance and closing
          services in several states. Not all products are available in all
          states. Better Settlement Services, LLC is a wholly-owned subsidiary
          of Better Mortgage Corporation. Better Settlement Services, LLC and
          Better Mortgage Corporation are not affiliated with any real estate
          brokerage.
        </p>
      </div>
    </footer>
